...
public class JSplashPage extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.splashpage);   // Create the view from splashpage.xml
        ...
        Thread splashTread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Intent intent = new Intent(JSplashPage.this, JMainMenu.class);
